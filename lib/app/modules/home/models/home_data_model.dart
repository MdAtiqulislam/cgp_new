...
class HomeDataModel {
  ...
  final String? status;
  final List<Category>? categories;
  final List<SingleWarehouseBranchModel>? warehouseBranches;
  final List<SingleProductModel>? products;
  ...
  factory HomeDataModel.fromJson(Map<String, dynamic> json) => HomeDataModel(
    ...
    status: json["status"],
    categories: json["categories"] == null ? [] : List<Category>.from(json["categories"]!.map((x) => Category.fromJson(x))),
    warehouseBranches: json["warehouseBranches"] == null ? [] : List<SingleWarehouseBranchModel>.from(json["warehouseBranches"]!.map((x) => SingleWarehouseBranchModel.fromJson(x))),
    products: json["products"] == null ? [] : List<SingleProductModel>.from(json["products"]!.map((x) => SingleProductModel.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "status": status,
    "categories": categories == null ? [] : List<dynamic>.from(categories!.map((x) => x.toJson())),
    "warehouseBranches": warehouseBranches == null ? [] : List<dynamic>.from(warehouseBranches!.map((x) => x.toJson())),
    "products": products == null ? [] : List<dynamic>.from(products!.map((x) => x.toJson())),
  };
}
